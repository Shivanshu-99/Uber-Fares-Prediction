...
#function for input
def user_report():
    passenger = st.sidebar.number_input('Passenger Count',1,10,1)
    ...
    day_weekend = st.sidebar.number_input('Is your day of journey is on weekend(yes=1,No=0)',min_value=0,max_value=1,step=1) 
    ...
    distance = st.sidebar.number_input('distance  of journey',min_value=1.0,max_value=100.0,step=0.5) 
